...
namespace Mobile_Shop_Management_System {
    public partial class AddPurchase : Form {
        ...
        private void AddPurchase_Load(object sender, EventArgs e) {
            ...
            reader = cmd.ExecuteReader();
            while(reader.Read()) {
                ComBox_Suppliers.Items.Add(reader[0]);
            }
            cmd.Dispose();
            con.Close();
        }
        ...
        private void Btn_Clear_Click(object sender, EventArgs e) {
            ...
            ComBox_Suppliers.SelectedItem = null;
        ...
        private void Btn_Submit_Click(object sender, EventArgs e) {
            ...
            if((ComBox_Phones.SelectedItem != null || ComBox_Accessories.SelectedItem != null) && ComBox_Suppliers.SelectedItem != null) {
                int p_id = 0, a_id = 0, c_id = 0, b_id = 0, s_id = 0, a_qty=0, p_qty=0; string sql = "";
                OleDbConnection con = new OleDbConnection(Program.ConnectionString);
                con.Open();
                ...
                if(ComBox_Suppliers.SelectedItem != null) {
                    sql = "select SupplierID from Suppliers where SName=@name";
                    cmd.CommandText = sql;
                    cmd.Parameters.AddWithValue("@name", ComBox_Suppliers.SelectedItem.ToString());
                    reader = cmd.ExecuteReader();
                    while(reader.Read()) {
                ...
                TimeSpan time = Picker_Date.Value.TimeOfDay;
        ...
        private void Btn_Calc_Click(object sender, EventArgs e) {
            ...
            if(ComBox_Phones.SelectedItem != null && Qty_Phone.Value != 0) {
                ...
                reader = cmd.ExecuteReader();
                while(reader.Read()) {
                    amount += reader.GetInt32(0) * int.Parse(Qty_Phone.Value.ToString());
                }reader.Close();
                cmd.Parameters.Clear();
            }
            ...
            if(ComBox_Accessories.SelectedItem != null && Qty_Accessories.Value != 0) {
                ...
                reader = cmd.ExecuteReader();
                while(reader.Read()) {
                    amount += reader.GetInt32(0) * int.Parse(Qty_Accessories.Value.ToString());
                }reader.Close();
                cmd.Parameters.Clear();
            }
        ...
        private void Btn_Bill_Click(object sender, EventArgs e) {
            ...
            if(ComBox_Phones.SelectedItem != null || ComBox_Accessories.SelectedItem != null) {
                ...
                txt.Text = ComBox_Suppliers.Text;
